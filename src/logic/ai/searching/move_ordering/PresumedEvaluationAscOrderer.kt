...
class PresumedEvaluationAscOrderer(private val evaluator: Evaluator) : SearchMoveOrderer {
    override fun getOrderedPossibleMoves(board: GameBoard, possibleMoves: Set<Int>) = possibleMoves
            .toMutableList()
            .sortedBy { evaluator.evaluate(makeMove(board.getCopy(), it, FieldState.WHITE), FieldState.WHITE) }
